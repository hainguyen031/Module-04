...
<div class="container-fluid px-3 py-3">
    ...
    <h6 class="text-center"> ĐÂY LÀ TÀI LIỆU QUAN TRỌNG, THÔNG TIN CỦA ANH/CHỊ SẼ GIÚP CƠ QUAN Y TẾ LIÊN LẠC KHI CẦN
        THIẾT ĐỂ PHÒNG CHỐNG DỊCH BỆNH
        TRUYỀN NHIỄM </h6>
    <P class=" text-center text-danger"> Khuyến cáo: Khai báo thông tin sai là vi phạm pháp luật Việt Nam và có thể bị
        xử lý hình sự</P>
    ...
    <div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <form:select path="birthday" items="${years}" cssClass="form-control"
                             value="${healthDeclaration.birthday}">
                </form:select>
            </div>
            <div class="form-group col-md-4">
                <label>Giới tính </label> <span class="text-danger font-italic">(*)</span>
                <form:select path="gender" items="${genders}" cssClass="form-control"
                             value="${healthDeclaration.gender}">
                </form:select>
            </div>
            <div class="form-group col-md-4">
                <label>Quốc tịch </label> <span class="text-danger font-italic">(*)</span>
                <form:select path="national" items="${nations}" cssClass="form-control"
                             value="${healthDeclaration.national}">
                </form:select>
            </div>
        </div>
        <div class="form-group">
            <label>Số hộ chiếu hoặc số CMND hoặc giấy thông hành hợp pháp khác</label> <span
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <form:input type="date" path="dateStart" cssClass="form-control"
                            value="${healthDeclaration.dateStart}"/>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-group">
            <label>Trong vòng 14 ngày qua, Anh/Chị có đến Tỉnh/Thành phố nào?</label> <span
                class="text-danger font-italic">(*)</span>
            <form:textarea class="form-control" path="cityArrived" rows="3"
                           value="${healthDeclaration.cityArrived}"></form:textarea>
        </div>
